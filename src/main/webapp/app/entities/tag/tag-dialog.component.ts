...
import { Plat, PlatService } from '../plat';
...
export class TagDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.platService.query()
            .subscribe((res: HttpResponse<Plat[]>) => { this.plats = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    trackPlatById(index: number, item: Plat) {
        return item.id;
    }
