...
public class MenuwebApp {

    private static final Logger log = LoggerFactory.getLogger(MenuwebApp.class);

    private final Environment env;

    public MenuwebApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MenuwebApp.class);
