...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Tag.class.getName() + ".plats", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Plat.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Plat.class.getName() + ".tags", jcacheConfiguration);
